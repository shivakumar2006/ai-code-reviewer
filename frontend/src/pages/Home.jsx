    ...
    return (
      ...
      `}</style>
            ...
            <nav style={{
                ...
                <button onClick={() => Navigate("/login")} className="btn-primary" style={{ padding: "10px 24px", fontSize: "11px" }}>
                    Launch App →
                </button>
            </nav>
            ...
            <section ref={heroRef} style={{
                ...
                <div style={{ flex: 1, maxWidth: "700px" }}>
                    ...
                    <div className="fade-up stagger-4" style={{
                        ...
                        <button onClick={() => Navigate("/login")} className="btn-primary">Start Reviewing →</button>
                        <a
                            href="https://github.com/shivakumar2006/ai-code-reviewer"
                            target="_blank"
            ...
            <section id="get-started" style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <button onClick={() => Navigate("/login")} className="btn-primary" style={{ fontSize: "13px", padding: "16px 40px" }}>
                            Launch App →
                        </button>
